...
<div class="box">
  ...
  <form method="POST" action="/reset-device">
    ...
    <div class="form-row" style="margin:10px 0 6px; display:flex; align-items:center; gap:8px;">
      <input id="no_email" type="checkbox" name="no_email" value="1" <?php echo !empty($form['no_email']) ? 'checked' : ''; ?>>
      <label for="no_email" class="form-label" style="margin:0; font-weight:500;">Không có email</label>
    </div>
