# -*- coding: utf-8 -*-
"""Bump version to 1.0.1 and publish app-v1.0.1.zip so all customer launchers auto-update."""
...
def bump_to_101():
    ...
    dst_zip = DIST_DIR / "app-v1.0.1.zip"
    ...
    # Upload app-v1.0.1.zip to R2
    print(f"\n[1/2] Uploading app-v1.0.1.zip to R2...")
    upload_file(client, dst_zip, bucket, "app/app-v1.0.1.zip", "application/zip")
    
    # Update manifest.json
    print(f"\n[2/2] Updating manifest.json to v1.0.1...")
    ...
    manifest["app_package"] = {
        ...
        "url": f"{base_url}/app/app-v1.0.1.zip",
        "sha256": sha256,
    ...
    print("\n[SUCCESS] Đã kích hoạt cơ chế tự động cập nhật OTA v1.0.1 thành công!")
    print("Mọi Launcher của khách hàng khi mở lên sẽ TỰ ĐỘNG tải bản vá v1.0.1 về máy!")
